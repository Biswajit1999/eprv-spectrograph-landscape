...
from .analysis import performance_evidence_summary, spectral_coverage_summary, status_summary
from .data import load_instruments
from .plots import plot_resolution_coverage, plot_wavelength_coverage
...
def build_cmd(data_path: str, out_dir: str) -> None:
